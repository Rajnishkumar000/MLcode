...
#no of missing dataset
print(df.isnull().sum())
print("\n\n")

#no of duplicate dataset whole row
print(df.duplicated().sum())
print("\n\n")

#gives count of duplicate and non duplicate rows
print(df['is_duplicate'].value_counts())
print("\n\n")

#Gives percentage of the same
print((df['is_duplicate'].value_counts()/df['is_duplicate'].count())*100)
print("\n\n")

#Plots graph for the same
...
#gives count of duplicate and non duplicate rows
print(newdf['is_duplicate'].value_counts())
print("\n\n")

#Gives percentage of the same
print((newdf['is_duplicate'].value_counts()/newdf['is_duplicate'].count())*100)
print("\n\n")
